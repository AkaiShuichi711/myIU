...
@layer utilities {
  ...
  .base-medPasm {
    @apply text-[16px] font-medPasm leading-[140%];
  }
  ...
  .body-medPasm {
    @apply text-[18px] font-medPasm leading-[140%];
  }
  ...
  .small-medPasm {
    @apply text-[14px] font-medPasm leading-[140%];
  }
  ...
  .tiny-medPasm {
    @apply text-[10px] font-medPasm leading-[140%];
  }
  ...
  .post_details-delete_btn {
    @apply p-0 flex gap-3 hover:bg-transparent hover:text-light-1  text-light-1 small-medPasm lg:base-medPasm;
  }
  ...
  .leftsidebar-link {
    @apply rounded-lg base-medPasm hover:bg-primary-500 transition;
  }
