...
const MentionInput = ({
  ...
  const defaultClass =
    'w-full px-3 py-2.5 text-sm rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0057A8]/20 focus:border-[#0057A8] transition-all resize-none placeholder:text-slate-400';
