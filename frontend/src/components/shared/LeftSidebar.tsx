  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center shrink-0 transition-colors border-t border-[#E0E4EB] dark:border-[#33485c] text-slate-400 hover:text-[#0085b3]"
        style={{ height: '36px' }}
      ...
      >
        ...
        {!collapsed && (
          <Link
            to={`/update-profile/${user?.id}`}
            className="min-w-0 flex-1 overflow-hidden hover:text-[#0085b3] transition-colors"
          >
            <p
