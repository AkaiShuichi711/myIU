  ...
  return (
    ...
    >
                ...
                <>
                  {isActive && (
                    <span
                      ...
                      style={{ width: '3px', height: '16px', background: '#323393', borderRadius: '0 3px 3px 0' }}
                    />
                  )}
                  <div className="relative shrink-0">
                    <Icon size={15} style={{ color: isActive ? '#323393' : '#272e35' }} />
                    {badge && collapsed && (
                  ...
                  {!collapsed && (
                    <span
                      ...
                      style={{ color: isActive ? '#323393' : '#272e35' }}
                    >
      ...
      <button
        ...
        className="flex items-center justify-center shrink-0 transition-colors border-t border-[#E0E4EB] dark:border-[#33485c] text-slate-400 hover:text-[#4040aa]"
        style={{ height: '36px' }}
      ...
      >
        ...
        {!collapsed && (
          <Link
            to={`/update-profile/${user?.id}`}
            className="min-w-0 flex-1 overflow-hidden hover:text-[#4040aa] transition-colors"
          >
            <p
