    ...
    <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 bg-slate-50 dark:bg-slate-800/60">
        <button
          ...
          className="flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-[#4040aa] transition-colors"
        >
          ...
          {isLecturer && (
            <>
              <button
                ...
                className="text-[11px] text-slate-500 dark:text-slate-400 hover:text-[#4040aa] transition-colors flex items-center gap-1"
              >
          ...
          {showAddMember && isLecturer && (
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                disabled={isAdding}
                className="px-3 py-2 rounded-lg text-xs font-semibold text-white bg-[#323393] hover:bg-[#0087b3] transition-colors shrink-0 disabled:opacity-60"
              >
    ...
    <div className="min-h-full bg-[#F8FAFC] dark:bg-[#19191a]">
      ...
      <div className="sticky top-0 z-10 bg-white dark:bg-[#19191a] border-b border-slate-200 dark:border-slate-800 px-6 py-3">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link to="/courses" className="flex items-center gap-1 text-[11px] text-slate-400 hover:text-[#4040aa] transition-colors font-mono">
          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 p-4 mb-4 flex flex-col gap-3">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg text-xs font-semibold text-white bg-[#323393] hover:bg-[#0087b3] transition-colors disabled:opacity-60 flex items-center gap-1.5"
              >
              ...
              <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 hover:text-[#4040aa] transition-colors"
                  >
                ...
                <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold text-white bg-[#323393] hover:bg-[#0087b3] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <div className="flex-1 h-1.5 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                                <div className="h-full bg-[#323393] rounded-full transition-all" style={{ width: `${score * 10}%` }} />
                              </div>
