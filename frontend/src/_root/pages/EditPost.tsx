      ...
      <div className="bg-white dark:bg-[#19191a] border-b border-slate-100 dark:border-slate-700 px-6 py-5">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-[#323393]/10 flex items-center justify-center">
            <Edit3 size={18} className="text-[#323393]" />
          </div>
          <div>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <textarea
                        {...field}
                        rows={4}
                        className="w-full px-3 py-2.5 text-sm rounded-xl bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-[#323393]/20 focus:border-[#323393] transition-all resize-none placeholder:text-slate-400 dark:placeholder:text-slate-500"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
