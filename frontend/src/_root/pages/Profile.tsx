    ...
    <div className="min-h-full bg-[#F8FAFC] dark:bg-slate-900">
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          {isOwnProfile && (
            <Link
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-[#0057A8] dark:text-blue-400 bg-[#0057A8]/8 dark:bg-[#0057A8]/20 hover:bg-[#0057A8]/12 transition-colors"
            >
      ...
      <div className="max-w-5xl mx-auto px-6 py-4 flex flex-col gap-3">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
          {/* Cover */}
          <div className="h-20" style={{ background: 'linear-gradient(135deg, #0057A8 0%, #0057A8 100%)' }} />
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-50 dark:border-slate-700">
              <div className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center">
                <User size={15} className="text-[#0057A8]" />
              </div>
