    ...
    return (
      <div className="min-h-full bg-[#F8FAFC] dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/sign-in" className="px-4 py-2 rounded-lg bg-[#0057A8] text-white text-sm font-semibold">Đăng nhập</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-full bg-[#F8FAFC] dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate(-1)} className="mt-3 text-sm text-[#0057A8] hover:underline">Quay lại</button>
        </div>
      </div>
    );
  }
        ...
        {isApprover && isStatusPending && !actionDone && (
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
            <div className="flex items-center gap-2 mb-3">
              <User size={14} className="text-[#0057A8]" />
