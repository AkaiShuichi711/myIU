        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-2">
          ...
          <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-700 rounded-xl p-1 shrink-0">
            <button
              ...
              className={`p-2 rounded-lg transition-all ${viewMode === 'feed' ? 'bg-white dark:bg-slate-600 shadow-sm text-[#0057A8]' : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300'}`}
              title="Feed view"
            >
              <List size={16} />
            </button>
            <button
              ...
              className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-white dark:bg-slate-600 shadow-sm text-[#0057A8]' : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300'}`}
              title="Grid view"
            >
              <LayoutGrid size={16} />
            </button>
