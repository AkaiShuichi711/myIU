        ...
        <div>
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-[#009CD1] bg-[#009CD1]/8 border border-[#009CD1]/20 hover:bg-[#009CD1]/12 transition-colors disabled:opacity-60"
            >
          ...
          {isPending ? (
            ...
            <div className="divide-y divide-slate-50 dark:divide-[#0d2137]">
              {notifications.map((n: any) => {
                ...
                const content = (
                  <div
                    className={`flex items-start gap-3 px-5 py-4 hover:bg-slate-50 dark:hover:bg-[#0d2137] transition-colors cursor-pointer ${!n.read ? 'bg-[#009CD1]/4 dark:bg-[#009CD1]/6' : ''}`}
