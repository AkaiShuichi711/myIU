        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "32px 24px 60px" }}>
          ...
          {loading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              <Section title={t('tenant.sessionClaims')} accent="#0057A8"
                icon={<Fingerprint size={15} color="#0057A8" />}>
                {[
              ...
              <Section title={t('tenant.identityMetadata')} accent="#0057A8"
                icon={<ShieldCheck size={15} color="#0057A8" />}>
              ...
              {tenant.graphProfile && (
                <Section title={t('tenant.graphProfile')} accent="#0057A8"
                  icon={<User size={15} color="#0057A8" />}>
                  {[
