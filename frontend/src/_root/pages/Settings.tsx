            ...
            {tabs.map((tb) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-4 py-3.5 text-sm font-medium transition-colors border-b-2 ${
                  tab === tb.id
                    ? 'border-[#0057A8] text-[#0057A8] bg-[#0057A8]/4 dark:bg-[#0057A8]/10'
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border-2 text-left transition-all ${
                      currentLang === opt.code
                        ? 'border-[#0057A8] bg-[#0057A8]/5 dark:bg-[#0057A8]/10'
        ...
        {tab === 'sessions' && (
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
              ...
              {isLoadingSessions ? (
                <div className="flex justify-center py-8"><Loader2 size={18} className="animate-spin text-[#0057A8]" /></div>
              ) : currentSession ? (
