...
const PALETTE = ['#1D4ED8', '#7C3AED', '#0891B2', '#059669', '#B45309', '#DC2626', '#19191a', '#F47A50'];
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 w-full">
        ...
        {user.roles?.length > 0 && (
          <span className="inline-block mt-2 px-2 py-0.5 rounded-full bg-[#F47A50]/8 dark:bg-[#F47A50]/20 text-[#F47A50] dark:text-blue-400 text-xs font-medium">
            {user.roles[0]}
          </span>
        )}
      </div>
        ...
        <div className="max-w-5xl mx-auto flex items-center gap-4">
          <div className="flex items-center gap-3 shrink-0">
            <div className="w-9 h-9 rounded-xl bg-[#F47A50]/10 flex items-center justify-center">
              <Users size={18} className="text-[#F47A50]" />
            </div>
