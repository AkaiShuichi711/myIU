...
export const FORM_STATUS: Record<SubmissionStatus, {
  ...
  pending:  { label: 'Chờ duyệt',  color: 'text-[#f5832f]', bg: 'bg-[#f5832f]/10', cls: 'border border-[#f5832f]/40 text-[#f5832f]', hex: '#f5832f', Icon: Clock        },
  approved: { label: 'Đã duyệt',   color: 'text-[#00c578]', bg: 'bg-[#00c578]/10', cls: 'border border-[#00c578]/40 text-[#00c578]', hex: '#00c578', Icon: CheckCircle2  },
  rejected: { label: 'Đã từ chối', color: 'text-[#ef4e49]', bg: 'bg-[#ef4e49]/10', cls: 'border border-[#ef4e49]/40 text-[#ef4e49]', hex: '#ef4e49', Icon: XCircle       },
};
...
export const FILE_TYPE_META: Record<FormFileType | 'other', { label: string; color: string; bg: string }> = {
  ...
  docx:  { label: 'DOCX', color: 'text-[#0057A8]', bg: 'bg-[#0057A8]/10' },
